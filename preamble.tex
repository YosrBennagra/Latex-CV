...
\newcommand{\cvsection}[1]{%
  \vspace{6pt}\par\textbf{\large #1}\par\vspace{2pt}\hrule height 0.6pt \vspace{4pt}
}

% Header macro - name centered, contact below
\newcommand{\makecvheader}{%
  \begingroup
  \par\vspace*{0pt}
  {\centering\Large\textbf{\MakeUppercase{\CVName}}\par}
  \vspace{3pt}
  \endgroup
}

% Contact information - compact single line, centered
\newcommand{\makecontactinfo}{%
  {\centering\small
    \CVPhone~\textbar~\href{mailto:\CVEmail}{\CVEmail}~\textbar~\CVAddress%
    \ifx\CVGithub\empty\else~\textbar~\href{\CVGithub}{GitHub}\fi%
    \ifx\CVWebsite\empty\else~\textbar~\href{\CVWebsite}{Portfolio}\fi%
    \par}\vspace{4pt}
}
...
\newenvironment{internship}[5]{%
  ...
  #2\\[-4pt]
  \ifx&#5&\else{\footnotesize\textcolor{gray}{#5}}\\[-5pt]\fi
