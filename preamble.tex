...
\usepackage{lmodern}        % Clean, standard font family
% Uncomment next two lines to switch to a sans-serif look (HR-safe)
%\renewcommand{\familydefault}{\sfdefault}
%\providecommand{\engine@font}{sans}
...
\newcommand{\cvsection}[1]{%
  \vspace{6pt}\par\textbf{\Large #1}\par\vspace{4pt}\hrule height 0.5pt \vspace{6pt}
}
...
\newcommand{\makecvheader}{%
  \begingroup
  \par\vspace*{4pt}
  {\Large\textbf{\MakeUppercase{\CVName}}\hfill\normalsize \CVRole}\par
  \vspace{4pt}
  \endgroup
}
...
\newcommand{\makecontactinfo}{%
  {\small
    	...
    	\textbf{Email:}~\CVEmail \hfill \textbf{Github:}~\href{\CVGithub}{\CVGithub}%
  }\par\vspace{8pt}
}
...
\newenvironment{internship}[5]{%
  \par\textbf{#1}\\[-2pt]
  #2\\[-2pt]
  {\footnotesize\textit{#4}}\\[-2pt]
  {\footnotesize\emph{#5}}\\[-2pt]
  {\footnotesize\textit{Tasks}}\\[-4pt]
...
% Page style: no headers/footers except page number if >1 page
\pagestyle{plain}
