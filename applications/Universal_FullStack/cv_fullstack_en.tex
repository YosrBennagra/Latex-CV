...
\begin{center}
  ...
  {\footnotesize
    ...
    \faMapMarkerAlt\ Tunis, Tunisia \\[2pt]
...
\textit{Tunis, Tunisia}
\begin{itemize}
  \item Handle inbound/outbound customer inquiries, resolve support tickets via \textbf{CRM tools}, and provide \textbf{multilingual support} (English, French, Arabic)
  \item Maintain high \textbf{customer satisfaction} scores through effective communication, active listening, and first-call resolution
\end{itemize}
}
...
\vspace{3pt}
\textbf{Overlayos -- Operations Dashboard} \\[1pt]
\textit{React, TypeScript, Node.js/Express, PostgreSQL, MongoDB, Socket.io, Docker, K8s, Helm}
\begin{itemize}
  \item Built a centralized dashboard for tracking meetings, platform tools, and user/admin management
  \item Implemented real-time updates via Socket.io, role-based access (JWT/RBAC), and containerized deployment
\end{itemize}
